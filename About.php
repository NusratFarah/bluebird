...
<table border="1"align="center" width="60%" >
			...
			<tr background="white.jpg">
				<td>
					...
					<br><br>
					<p>This hotel privately run 4-star hotel is peacefully situated among pretty fields.</p> 
					<p>Just a 5-minute drive from Timmendorfer Strand's town centre and beach. 
					   Free WiFi is available throughout.</p>
